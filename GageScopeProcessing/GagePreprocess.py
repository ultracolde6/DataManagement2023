...
# TODO: In this shot based scheme of raw data, the gage pre-processor will need to crawl through
# a folder with all raw data from a single run and stitch them together into a single file. Let's' correct the crawling to do that
